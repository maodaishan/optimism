...
func RunProgram(logger log.Logger, preimageOracle io.ReadWriter, preimageHinter io.ReadWriter) error {
	...
	return runDerivation(
		...
		bootInfo.DAConfig,	//DePIN DA,celestia add
...
func runDerivation(logger log.Logger, cfg *rollup.Config,daCfg *rollup.DAConfig, l2Cfg *params.ChainConfig, l1Head common.Hash, l2OutputRoot common.Hash, l2Claim common.Hash, l2ClaimBlockNum uint64, l1Oracle l1.Oracle, l2Oracle l2.Oracle) error { //DePIN DA,celestia add
	...
	d := cldr.NewDriver(logger, cfg, daCfg,l1Source, l2Source, l2ClaimBlockNum) //DePIN DA,celestia add
	for {
