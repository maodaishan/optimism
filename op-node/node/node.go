...
import (
	...
	"github.com/ethereum-optimism/optimism/op-node/rollup"	//DePIN DA,celestia add
...
type OpNode struct {
	...
	daCfg     *rollup.DAConfig	// DePIN DA,celestia add,da config
